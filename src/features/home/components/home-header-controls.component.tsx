  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className="group inline-flex h-10 w-16 items-center justify-center rounded-2xl border border-border/60 bg-white/82 px-1.5 text-primary shadow-[0_8px_22px_rgba(15,23,42,0.05)] transition duration-300 hover:-translate-y-0.5 hover:border-primary/20 hover:bg-primary/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:bg-white/8 dark:focus-visible:ring-offset-slate-950"
      >
        <span dir="ltr" className="relative flex h-7 w-12 items-center rounded-full border border-border/60 bg-surface-soft p-0.5 transition duration-300 group-hover:bg-primary/10">
          <span
            className={`flex h-6 w-6 items-center justify-center rounded-full bg-white text-primary shadow-[0_4px_10px_rgba(17,24,39,0.12)] transition duration-300 ${
