...
const checkoutCopyByLocale: Readonly<Record<Locale, CheckoutCopy>> = {
  en: {
    ...
    library: {
      ...
      subtitle: "Continue courses and access books purchased through your IASS account.",
      coursesTab: "Purchased Courses",
      booksTab: "Purchased Books",
      continueLearning: "Continue Learning",
      accessBook: "Access Book",
  ...
  ar: {
    ...
    library: {
      ...
      subtitle: "تابع الكورسات وافتح الكتب التي اشتريتها من حسابك في IASS.",
      coursesTab: "الكورسات المشتراة",
      booksTab: "الكتب المشتراة",
      continueLearning: "متابعة التعلم",
      accessBook: "فتح الكتاب",
