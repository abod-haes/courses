...
export async function AuthPage({ mode }: AuthPageProps) {
  ...
  return (
    <div className="relative min-h-full overflow-hidden bg-section-bg">
      ...
      <section className="relative mx-auto grid min-h-[calc(100vh-8rem)] max-w-7xl items-center gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[minmax(0,1.02fr)_minmax(25rem,0.78fr)] lg:px-8 lg:py-12">
